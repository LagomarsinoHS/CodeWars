...
const longArray = Array.from({ length: 1001 }, (_, i) => i)


const normalSearch = (array, valueToSearch) => {
    let time = 0;
...
const valueToSearch = 1000

const resNormalSearch = normalSearch(longArray, valueToSearch)
console.log("Normal Search ->", resNormalSearch);
